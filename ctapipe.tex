...
\begin{tikzpicture}
  ...
  \node[] (ctapipe) at (0, 0) {\includegraphics[width=10cm]{logos/ctapipe_logo_square.png}};

  \node[anchor=east, lightbg] (astropy) at (-8, 4.5) {\includegraphics[height=2cm]{logos/astropy.pdf}};
  \node[anchor=north west, yshift=-0.5cm] (sklearn) at (astropy.south west) {\includegraphics[height=2cm]{logos/sklearn.pdf}};
  ...
  \node[anchor=north, yshift=-0.5cm] (github) at (pytest.south) {\includegraphics[width=4cm]{logos/github.pdf}};
\end{tikzpicture}
}
